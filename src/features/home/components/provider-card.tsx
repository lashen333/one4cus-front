    ...
    <article className="flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <Link
          ...
          className="mt-auto inline-flex h-11 w-full items-center justify-center rounded-md border border-[#1677c8] text-sm font-medium text-[#1677c8] transition hover:bg-blue-50"
        >
          View Profile
        </Link>
      </div>
